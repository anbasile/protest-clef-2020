...
do
    ...
    do 
        ...
        do
            ...
            do
            protesta fit tagger $decoding $mode $model /content/drive/My\ Drive/protesta-data/task3/ $decoding $mode
            if [ $decoding = "--crf-decoding" ]; then
                decoding_boolean="True"
            else
                decoding_boolean="False"
            fi
            protesta predict outputs/tagger_${model}_${decoding_boolean}_${mode} /content/drive/My\ Drive/protesta-data/task3/test.data
