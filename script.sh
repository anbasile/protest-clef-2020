...
do
    ...
    do 
        ...
        mv /content/drive/My\ Drive/protesta-data/task3/test.tagger_${model}_${decoding_boolean} ./task3_test.predict
        mv /content/drive/My\ Drive/protesta-data/task3/china_test.tagger_${model}_${decoding_boolean} ./china_test.predict
        zip /content/drive/My\ Drive/protest-predictions-and-models/${model}_${decoding_boolean}.zip ./task3_test.predict ./china_test.predict
