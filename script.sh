...
do
    ...
    do 
        ...
        do
            ...
            zip /content/drive/My\ Drive/protest-predictions-and-models_bert_retrain_epochs/${model}_${decoding_boolean}_${mode}.zip ./task3_test.predict ./china_test.predict
            tar -cvf /content/drive/My\ Drive/protest-predictions-and-models_bert_retrain_epochs/tagger_${model}_${decoding_boolean}_${mode}_${datasize}.tar.gz outputs/tagger_${model}_${decoding_boolean}_${mode}_${datasize}
