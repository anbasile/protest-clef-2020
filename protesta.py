...
def fit(
    ...
    pretrained_model: str = typer.Argument("google/mobilebert-uncased", help="The pretrained transformer to use"),
    max_length: int = typer.Argument(..., help="The max length of a single instance"),
    ...
    """
        TODO
    """
    trainer = t.Trainer(model_type, pretrained_model, max_length, dataset, crf_decoding)
    trainer.run()
